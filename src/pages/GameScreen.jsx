...
const dungeon = {
  ...
  description:
    "A haunted crypt deep beneath the ruins of a forgotten castle. Whispers echo through the stone halls.",
  id: "crypt-001",
  rooms: [
    {
      id: 1,
      ...
      description:
        "The heavy stone door groans as it opens, revealing a tomb untouched for centuries.",
      monsters: [
        {
          id: 1,
          name: "Crypt Guardian",
    ...
    },
    {
      ...
      description:
        "Ghostly whispers fill the corridor. A faded inscription on the wall hints at a puzzle.",
      monsters: [],
    ...
    },
    {
      ...
      description:
        "A trick room filled with mirrored illusions. One step in the wrong direction could be fatal.",
      monsters: [
        {
          id: 2,
          name: "Phantom Shade",
    ...
    },
    {
      ...
      description:
        "An ancient undead king rises from his throne, sword in hand. His gaze pierces your soul.",
      monsters: [
        {
          id: 3,
          name: "Forgotten King",
    ...
    },
    {
      ...
      name: "Secret Vault",
      description:
        "Behind the throne lies a hidden chamber filled with treasure and the King's forgotten journal.",
      monsters: [],
      exits: [],
    },
  ],
